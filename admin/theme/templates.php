        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" > EZShopping</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <!--     <li>
                       ...
                       <!--   <li>
						...
						<button onclick="myonclickFn()">Ezshopping chart</button>
						<script>
							function myonclickFn(){
								document.location.href="http://localhost:8012/EZ-Shop%20chart/lib/";
								
							}
							</script>
						<button onclick="myonclickFn()">ALL CHART</button>
						<script>
							function myonclickFn(){
								document.location.href="http://localhost:8012/EZ-Shop%20chart/lib/";
