...
-webkit-box-shadow:1px 2px 10px rgb(255,255,255,0.1), inset 10px 10px 10px #00f, inset -10px 10px 10px purple, inset 10px -10px 10px red, inset -10px -10px 10px #00f;
-moz-box-reflect: below 0px linear-gradient(transparent, rgba(0,0,0,0.1));
-moz-box-shadow:1px 2px 10px rgb(255,255,255,0.1), inset 10px 10px 10px #00f, inset -10px 10px 10px purple, inset 10px -10px 10px red, inset -10px -10px 10px #00f;
-ms-webkit-box-reflect: below 0px linear-gradient(transparent, rgba(0,0,0,0.1));
-ms-box-shadow:1px 2px 10px rgb(255,255,255,0.1), inset 10px 10px 10px #00f, inset -10px 10px 10px purple, inset 10px -10px 10px red, inset -10px -10px 10px #00f;
box-reflect: below 0px linear-gradient(transparent, rgba(0,0,0,0.1));
box-shadow:1px 2px 10px rgb(255,255,255,0.1), inset 10px 10px 10px #00f, inset -10px 10px 10px purple, inset 10px -10px 10px red, inset -10px -10px 10px #00f;
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +9476892566</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> ezshop@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href=""><img src="LOGO_EZS.png" height="130"/></a>
          ...
          <div class="col-sm-9">
            ...
            <div class="mainmenu pull-left">
              <ul class="nav navbar-nav collapse navbar-collapse">
                ...
                <li><a href="<?php web_root?>index.php?q=product">PRODUCT</a></li>
                <li><a href="<?php web_root?>index.php?q=contact">CONTACT
              </ul>
            </div>
          </div>
          <div class="col-sm-3">
